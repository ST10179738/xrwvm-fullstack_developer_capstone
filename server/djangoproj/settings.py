...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    '.proxy.cognitiveclass.ai',  # Wildcard allowing any cognitiveclass proxy domain  # noqa: E501
]

CSRF_TRUSTED_ORIGINS = [
    'https://*.proxy.cognitiveclass.ai',
    'https://sangiwenkwan-8000.theiadockernext-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai',  # noqa: E501
    'http://localhost:8000',
    'http://127.0.0.1:8000',
]
